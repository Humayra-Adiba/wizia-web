...
function GetStarted() {
  return (
    <>
      <div className="bg-[#002228] text-white pt-16 md:pt-[96px] h-[525px] md:h-[433px] lg:h-[443px]">
        <h3 className="text-center text-[20px] text-[#0FF1F6]">GET STARTED</h3>

        <h2 className="text-center text-[40px] md:w-[640px] mx-auto mt-[10px] md:mt-[23px]">
          <em className="md:inline block">Embrace</em> <span className="font-bold">the new era of</span> <em className="md:inline block">outbound.</em>
        </h2>
        <p className="text-center text-[20px] mt-[23px]">
          Wizia lets you train, activate, and optimize aiDRs. <br/>Take your outbound
